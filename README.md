...
- **Provider auth** with `serviceTicket` (logon, reuse in query string). [1](https://developer.hashicorp.com/terraform/plugin/framework/acctests)  
- **Data sources**
...
- **Resources**
 ...
 - Security modes (Open, WPA2‑PSK, WPA3‑SAE, WPA2/WPA3 mixed, 802.1X, Web‑auth, **Hotspot (WISPr)**). [3](https://github.com/hashicorp/terraform-provider-scaffolding-framework/blob/main/README.md)
    - VLAN (access VLAN, **Dynamic VLAN** via RADIUS attributes). [4](https://developer.hashicorp.com/terraform/plugin/framework/resources/block-types)
...
> 📘 **Docs references:**  
> • Ruckus SmartZone public API entry points & Version Matrix: Developer Central and v7.1.1 public API guides. [9](https://developer.ruckuswireless.com/)[2](https://github.com/hashicorp/terraform-plugin-go)  
